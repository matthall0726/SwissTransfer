...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        def loginbutton():
            ...
            if system_info.__contains__("linux"):
            ...
            elif system_info.__contains__("mac os"):  # fix:me - needs to correctly detect os
        ...
        # For Michael
        # my_image = customtkinter.CTkImage(light_image=Image.open("/home/paradox/PycharmProjects/SwissTransfer/Swiss Transfer/CTk Frame/Transfer Photo-850x330.jpeg"),
        #                                   dark_image=Image.open("/home/paradox/PycharmProjects/SwissTransfer/Swiss Transfer/CTk Frame/Transfer Photo-850x330.jpeg"),
        #                                   size=(800, 330))
